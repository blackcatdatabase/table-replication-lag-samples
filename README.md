...
> Schema package for table **replication_lag_samples** (repo: `replication-lag-samples`).
...
| metric | TEXT | NO | — |  |
| value | BIGINT | NO | — |  |
| captured_at | TIMESTAMPTZ(6) | NO | CURRENT_TIMESTAMP(6) |  |

## Relationships
- FK → **peer_nodes** via (peer_id) (ON DELETE CASCADE).
...
erDiagram
  ...
  REPLICATION_LAG_SAMPLES }o--|| PEER_NODES : "peer_id"
```
