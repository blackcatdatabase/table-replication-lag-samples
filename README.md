...
- Pkg folder: [packages\replication-lag-samples](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\replication-lag-samples)
...
graph LR
  ...
  replication_lag_samples["replication_lag_samples"]:::center
  replication_lag_samples -->|FK| peer_nodes["peer_nodes"]:::link
...
- `captured_at` – default=CURRENT_TIMESTAMP(6)
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-monitoring/040_views_modules.mysql.sql) | mysql |
| [040_views_modules.postgres.sql](schema/modules/blackcat-monitoring/040_views_modules.postgres.sql) | postgres |
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-monitoring/040_views_modules.mysql.sql) | mysql | package |
| [040_views_modules.postgres.sql](schema/modules/blackcat-monitoring/040_views_modules.postgres.sql) | postgres | package |
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package replication-lag-samples -Apply
