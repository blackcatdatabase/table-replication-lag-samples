...
| Pkg folder | [packages/replication-lag-samples](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/replication-lag-samples) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package replication-lag-samples -Apply
