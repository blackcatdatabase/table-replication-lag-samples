...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'peer_id', 'metric', 'value', 'captured_at' ];
    }
    ...
    {
        $x = [ 'id', 'peer_id', 'metric', 'value', 'captured_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\ReplicationLagSamples\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\ReplicationLagSamples\Definitions::softDeleteColumn();
