...
namespace BlackCat\Database\Packages\ReplicationLagSamples;
...
use BlackCat\Database\Packages\ReplicationLagSamples\Repository\ReplicationLagSampleRepositoryInterface;
use BlackCat\Database\Packages\ReplicationLagSamples\Repository\ReplicationLagSampleRepository as GeneratedRepository;
...
{
  private ReplicationLagSampleRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof ReplicationLagSampleRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected ReplicationLagSampleRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\ReplicationLagSamples\Dto\ReplicationLagSampleDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\ReplicationLagSamples\Dto\ReplicationLagSampleDto|null { return $this->repo->getById($id, $asDto); }
