...
use BlackCat\Database\Packages\ReplicationLagSamples\Repository\ReplicationLagSampleRepository;
...
{
    private ReplicationLagSampleRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new ReplicationLagSampleRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\ReplicationLagSamples\Dto\ReplicationLagSampleDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\ReplicationLagSamples\Dto\ReplicationLagSampleDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\ReplicationLagSamples\Dto\ReplicationLagSampleDto|null
    {
