...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'replication_lag_samples'; }
    public static function contractView(): string { return 'vw_replication_lag_samples'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'peer_id', 'metric', 'value', 'captured_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'peer_id', 'value' ]; }
