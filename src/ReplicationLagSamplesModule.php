...
final class ReplicationLagSamplesModule implements ModuleInterface
{
    public function name(): string { return 'table-replication_lag_samples'; }
    public function table(): string { return 'replication_lag_samples'; }
    ...
    public static function contractView(): string { return 'vw_replication_lag_samples'; }
...
SQL;
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_lag_peer_time' ],
            'foreignKeys' => [ 'fk_lag_peer' ],
        ];
    }
}
