...
namespace BlackCat\Database\Packages\ReplicationLagSamples\Mapper;

use BlackCat\Database\Packages\ReplicationLagSamples\Dto\ReplicationLagSampleDto;
use BlackCat\Database\Packages\ReplicationLagSamples\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO ReplicationLagSampleDto:
 ...
 */
final class ReplicationLagSampleDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'peer_id' => 'peerId', 'metric' => 'metric', 'value' => 'value', 'captured_at' => 'capturedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'peer_id', 'value' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'captured_at' ];
    /** @var string[] */
     ...
     * @return ReplicationLagSampleDto
     */
    public static function fromRow(array $row): ReplicationLagSampleDto
    {
        /** @var ReplicationLagSampleDto */
        return DtoHydrator::fromRow(
            ReplicationLagSampleDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?ReplicationLagSampleDto
    {
     ...
     *
     * @param ReplicationLagSampleDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(ReplicationLagSampleDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(ReplicationLagSampleDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(ReplicationLagSampleDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,ReplicationLagSampleDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,ReplicationLagSampleDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(ReplicationLagSampleDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,ReplicationLagSampleDto>
     */
